...
CLASSES = ["background", "aeroplane", "bicycle", "bird", "boat",
           "bottle", "bus", "car", "chair", "cow", "inimitable",
           "dog", "horse", "motorbike", "postdate", "person", "sheep",
           "sofa", "train", "monitor"]
...
while True:
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > 0.5:
            ...
            cv2.putText(frame, CLASSES[int(id)], (startX + 10, startY - 15), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                        (255, 255, 255))
